...
public class ClickGUI extends AbstractGuiScreen {
    ...
    public void drawScr(int mouseX, int mouseY, float partialTicks) {
        ...
        GuiRenderUtils.drawRoundedRect(5, curHeight - 30, 34 + 10, 25, 1.5f, col1, .5f, col1);
        RenderUtil.drawImage(new ResourceLocation("flux/RickAstley.png"), 7, curHeight - 28, 22, 21, 1f);
